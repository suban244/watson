...
TRANSACTIONS = [
    # food
    ("Grocery shopping at Whole Foods", "food", "Weekly grocery run, fruits vegetables and dairy"),
    ...
    ("Smoothie bar after gym", "food", "Protein smoothie with banana and peanut butter"),
    ("Late night snacks from 7-Eleven", "food", "Chips crisps and energy drink"),
    ("Farmers market fruit and veg", "food", "Seasonal vegetables and fresh strawberries"),
    ...
    # transport
    ("Uber ride to the airport", "transport", "Early morning ride to international terminal"),
    ...
    ("Parking fee downtown garage", "transport", "All day parking in city center garage"),
    ("Bike service and tune-up", "transport", "Annual bike maintenance brake pads and chain"),
    ...
    # entertainment
    ("Netflix monthly subscription", "entertainment", "Streaming subscription for movies and shows"),
    ("Spotify premium plan", "entertainment", "Monthly music and podcast streaming"),
    ("Cinema tickets Friday night", "entertainment", "Two tickets for new blockbuster film"),
    ("Steam game purchase", "entertainment", "New RPG game on PC platform"),
    ("Concert tickets live music", "entertainment", "Rock concert at Madison Square Garden"),
    ("Board game night purchase", "entertainment", "Catan and Ticket to Ride expansion packs"),
    ("Museum natural history visit", "entertainment", "Family tickets to natural history museum"),
    ("Kindle ebook bundle", "entertainment", "Three fiction novels downloaded"),
    ("Museum annual membership", "entertainment", "Yearly pass to art and science museums"),
    ...
    ("Pharmacy vitamins and supplements", "health", "Vitamin D omega-3 and multivitamins"),
    ("Eye exam and new glasses", "health", "Annual eye examination and prescription update"),
    ...
    ("Protein powder and shaker", "health", "Whey protein powder for post workout recovery"),
    # utilities
    ...
    ("Home insurance premium", "utilities", "Monthly home contents and building insurance"),
    ...
    # shopping
    ("Amazon order noise cancelling headphones", "shopping", "Sony WH-1000XM5 headphones for work from home"),
    ...
    ("Desk lamp and office supplies", "shopping", "LED desk lamp pens notebooks and folders"),
    ("Kitchen appliance blender", "shopping", "Vitamix high speed blender for smoothies"),
    ("Bedding sheets and pillows", "shopping", "Egyptian cotton duvet cover and pillowcases"),
    ("Phone case and screen protector", "shopping", "iPhone protective case and tempered glass"),
    # travel
    ("Flight to New York round trip", "travel", "Economy class round trip ticket to JFK"),
    ...
    ("Weekend hotel city break", "travel", "2 night stay in boutique bed and breakfast"),
    ("Travel insurance policy", "travel", "Comprehensive travel and medical insurance"),
    ("Luggage and packing cubes", "travel", "Hardshell carry-on and packing organizers"),
    ("Airport lounge day pass", "travel", "Priority pass lounge access during layover"),
    ("Tourist attraction tickets", "travel", "Empire State Building observation deck tickets"),
    ("Currency exchange travel money", "travel", "Euros and British pounds for European trip"),
    # miscellaneous
    ("Haircut and styling", "other", "Monthly haircut and beard trim at barber"),
    ("Dry cleaning suit and shirts", "other", "Formal suit and three dress shirts cleaned"),
    ...
    ("Newspaper digital subscription", "other", "Monthly New York Times digital access"),
    ...
    ("Stationery and art supplies", "other", "Sketchbook watercolours and fine liner pens"),
    ("Flowers and plant delivery", "other", "Bouquet of flowers and indoor succulent plant"),
    ...
    ("Umbrella and rain gear", "other", "Windproof compact umbrella and waterproof boots"),
    ("Language learning app", "other", "Duolingo Plus annual subscription for Spanish"),
    ("Meditation app subscription", "other", "Headspace annual mindfulness subscription"),
    ...
    ("Printer ink cartridges", "other", "Black and colour ink cartridges for home printer"),
    ("Extension cord and adapters", "other", "Power strip with USB ports and travel adapters"),
]
    ...
    async with httpx.AsyncClient() as client:
        for i, (title, category, description) in enumerate(TRANSACTIONS, 1):
            ...
            payload = {
                ...
                "is_expense": True,
                "category": category,
                "date": (now - timedelta(days=days_ago, hours=random.randint(0, 23))).isoformat(),
            }
